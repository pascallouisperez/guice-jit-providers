 ...
 */
public class JitBindingBuilder<T> implements SimplifiedScopedBindingBuilder {

  private final JitBindingImpl<T> binding;

  public JitBindingBuilder(JitBindingImpl<T> binding) {
